...
```shell
  docker buildx build -t philippecharriere494/compose-codex:latest . --load
```
...
```shell
  docker extension dev ui-source philippecharriere494/compose-codex:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug philippecharriere494/compose-codex:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset philippecharriere494/compose-codex:latest
```
...
```shell
docker extension update philippecharriere494/compose-codex:latest
```
...
```shell
docker extension rm philippecharriere494/compose-codex:latest
```
